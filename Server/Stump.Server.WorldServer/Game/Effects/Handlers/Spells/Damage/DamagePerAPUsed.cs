...
{
    [AISpellEffect(SpellCategory.DamagesAir, EffectsEnum.Effect_DamageAirPerAP)]
    [AISpellEffect(SpellCategory.DamagesFire, EffectsEnum.Effect_DamageFirePerAP)]
    [AISpellEffect(SpellCategory.DamagesWater, EffectsEnum.Effect_DamageWaterPerAP)]
    [AISpellEffect(SpellCategory.DamagesEarth, EffectsEnum.Effect_DamageEarthPerAP)]
    [AISpellEffect(SpellCategory.DamagesNeutral, EffectsEnum.Effect_DamageNeutralPerAP)]
